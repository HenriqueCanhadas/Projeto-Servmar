...
def main(novo_caminho):
    ...
    def abrir_radiobutton_modal():
        ...
        label = ctk.CTkLabel(nova_janela, text="Escolha o Terceiro\n Valor de Referencia")
        label.pack(pady=10)  # Ajuste a distância vertical entre a label e os Radiobuttons
    ...
    def abrir_radiobutton_janela():
        ...
        # Variável para armazenar a escolha do usuário
        escolha_var = tk.StringVar(value=1)
        # Função para obter a escolha do usuário e atribuir à variável valor_terceario
        def obter_escolha():
            nonlocal valor_terceario, escolha_feita
            escolha = escolha_var.get()
            ...
            if ordem_planilhas.get() == 'c':
                ...
                if escolha == "Solo Prevenção":
                    ...
                    valor_terceario = 5
            print("Valor Secundario selecionado:", valor_terceario)
    ...
    # Restante do código pode continuar a partir daqui, usando os valores atualizados de ordem_planilhas e valor_terceario
    print("Ordem Planilhas:", ordem_planilhas.get())
    print("Valor Primário:", valor_terceario)

    print("Ordem Planilhas:", ordem_planilhas.get(), type(ordem_planilhas.get()))
    print("Valor Primário:", valor_terceario, type(valor_terceario))
